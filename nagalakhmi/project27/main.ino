...
void openLid() {
  servo.write(90); 
  Serial.println("open the door");// Open the lid by setting the servo angle to 90 degrees
}

void closeLid() {
  servo.write(0);  
  Serial.println("close the door");// Close the lid by setting the servo angle to 0 degrees
}
